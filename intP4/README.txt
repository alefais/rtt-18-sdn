...
• In another console tab start the Onos CLI by executing onos localhost
...
• In the Mininet CLI execute a pingall and then check the new Flow Rules installed in the
device